...
function Users({ Toggle }) {
    ...
    return (
        <div className='px-3'>
            ...
            {showForm && (
                <div className="modal fadein d-block" id="userForm" style={{ display: 'block', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            {showDeleteConfirmation && (
                <div className="modal fadein d-block" id="deleteConfirmationModal" style={{ display: 'block', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header">
